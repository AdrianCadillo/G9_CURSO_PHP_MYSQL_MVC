            ...
            <div class="col-xl-5 col-lg-5 col-md-8 col-12">
                <div class="card border-primary">
                    <div class="card-header bg-primary">
                        <h4 class="text-white">Numero de la suerte</h4>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <?php if(isset($_SESSION["error_suerte"])): ?>
                            <div class="alert alert-danger">
                                <?php echo $_SESSION["error_suerte"] ?>
                            </div>
                        <?php endif; unset($_SESSION["error_suerte"]) ?> 
                        <form action="../logica.php?accion=suerte" method="post" id="form_num_suerte">
                            <input type="date" name="fecha_nac" class="form-control">
                        </form>
                    </div>

                    <div class="card-footer">
                        <button class="btn btn-primary" onclick="document.getElementById('form_num_suerte').submit()">Evaluar</button>
                    </div>
                </div>
            </div>
        </div>
